/*
 * @file dtm_hw.c
 * @brief BL5340 DTM radio hardware specific data handlers.
 *
...
const uint32_t nrf_power_value[] = {
	...
	RADIO_TXPOWER_TXPOWER_Neg30dBm, RADIO_TXPOWER_TXPOWER_Neg20dBm,
	RADIO_TXPOWER_TXPOWER_Neg16dBm, RADIO_TXPOWER_TXPOWER_Neg12dBm,
